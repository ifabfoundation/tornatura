...
- [ ] (x) + (Ethel) Rilevamento, mettere dei Tooltip help (?)
...
- [ ] (a) iscrizione: breadcrumb è avanti di un passo (consensi, esito)
...
- [ ] (a) Btn "E⁠evidenzia": scroll to graphs
...
- [x] (a) Line graph: Controlla ordine dei punti
...
- [x] (a) Line graph: Controlla corrispondenza colori e dati con legende
